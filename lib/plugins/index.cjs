const DefaultFrontmatterPlugin = require("./default-frontmatter.cjs");


function MarkdownRemarkPlugin(eleventyConfig) {
...
module.exports = { DefaultFrontmatterPlugin, MarkdownRemarkPlugin };
